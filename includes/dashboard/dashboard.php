		...
		<div class="panel-body">
			<table class="form-table">
				...
				<tr class="radio-span" style="border-bottom:none;">
					<td>
						<span>
							<input type="radio" name="dashboard_status" value="disable" id="dashboard_status1" <?php if($dashboard_status == "disable") echo "checked"; ?> />&nbsp;<?php _e('Disabled','WEBLIZAR_ACL')?><br>
						</span>
						<span>
							<input type="radio" name="dashboard_status" value="enable" id="dashboard_status2" <?php if($dashboard_status == "enable") echo "checked";?> />&nbsp;<?php _e('Enable Custom Login','WEBLIZAR_ACL')?><br>
						</span>
					</td>
				</tr>
			</table>
